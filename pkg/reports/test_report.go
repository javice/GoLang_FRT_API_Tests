// pkg/reports/test_report.go

// Package reports contiene funciones para generar reportes de pruebas API en jsonplaceholder
...
func GenerateHTMLReport(results []TestResult, outputPath string) error {
    ...
    <body>
        <h1>Reporte HTML de Pruebas API en JsonPlaceholder</h1>
        {{range .}}
        <div class="test">
